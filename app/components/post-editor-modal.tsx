            ...
            <div className="absolute bottom-4 left-4 right-4 flex justify-between">
              ...
              <div className="flex gap-2">
                <Button
                  variant="ghost"
                  size="icon"
                  className="prev-button h-8 w-8 rounded-full bg-white/10 text-white hover:bg-white/20"
                ...
                <Button
                  variant="ghost"
                  size="icon"
                  className="next-button h-8 w-8 rounded-full bg-white/10 text-white hover:bg-white/20"
