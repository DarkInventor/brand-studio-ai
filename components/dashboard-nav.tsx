...
// //                       subItem.comingSoon && "cursor-not-allowed opacity-50"
// //                     )}
// //                   >
// //                     {subItem.title}
// //                     {subItem.comingSoon && (
...
// import { usePathname } from "next/navigation"
// import { cn } from "@/lib/utils"
// import { LayoutGrid, Calendar, Package, LogOut, Palette, Menu, ChevronDown } from "lucide-react"
// import { Button } from "@/components/ui/button"
// import { Sheet, SheetContent, SheetTrigger } from "@/components/ui/sheet"
// import { useState, useEffect } from "react"
// import { BrandLogo } from "@/components/brand-logo"
...
//               }}
//               className={cn(
//                 "flex flex-1 items-center gap-4 rounded-lg px-4 py-2.5 text-sm font-medium transition-colors ",
//                 pathname === item.href
//                   ? "bg-primary/10 text-primary"
//                   : "text-muted-foreground hover:bg-muted hover:text-foreground",
//               )}
...
//               {item.title}
//             </Link>
//             <CollapsibleTrigger className="flex items-center justify-center p-2 hover:bg-muted rounded-lg">
//               <ChevronDown
//                 className={cn("h-4 w-4 transition-transform", openCollapsible === item.title && "rotate-180")}
//               />
//             </CollapsibleTrigger>
//           </div>
//           <CollapsibleContent className="pl-8 pt-1 pb-1 mt-2">
...
//                   >
//                     {subItem.title}
//                     {subItem.comingSoon && <span className="text-xs text-muted-foreground">Coming Soon</span>}
//                   </Link>
//                 </li>
//               ))}
//             </ul>
